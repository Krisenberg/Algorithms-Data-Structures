...
public class Main {
	...
	public static void main(String[] args) {
		...
		while(!halt) {
			...
			if(word[0].equalsIgnoreCase("mergesortsecond") && word.length==1) {
				doc[currentDocNo].iterativeMergeSortSecond(doc[currentDocNo].getWeights());
				continue;
			}
			...
			if(word[0].equalsIgnoreCase("radixsortmodified") && word.length==1) {
				doc[currentDocNo].radixSortModified(doc[currentDocNo].getWeights());
				continue;
			}
